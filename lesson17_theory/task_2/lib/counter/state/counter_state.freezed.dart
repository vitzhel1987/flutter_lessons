...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  List<HistoryItem> history)  $default, {required CounterState Function() Increment}) {final _that = this;
switch (_that) {
case _CounterState():
return $default(_that.count,_that.history);case _:
  throw StateError('Unexpected subclass');
